...
public class RVSelectionType implements UserType {
    ...
    public Object nullSafeGet(ResultSet resultSet, String[] names, SessionImplementor s, Object owner)
        ...
        RVSelection result = null;
        Integer stateAsInt = resultSet.getInt(names[0]);
        if (!resultSet.wasNull()) {
            result = RVSelection.fromDBId(stateAsInt);
            if (result == null)
                throw new HibernateException("Unknown RV selection value '" + stateAsInt + "' in database.");
        }
        return result;
    }
    ...
    public void nullSafeSet(PreparedStatement statement, Object value, int index, SessionImplementor s)
          ...
          if (value == null) {
                statement.setNull(index, java.sql.Types.INTEGER);
                  ...
                  int stateAsInt = ((RVSelection)value).toDBId();
