...
/*        
  ...
  */    
        ...
        sb.append("<li>Many <u>other</u> key roles, details on the web site (Stage managers, volunteer coordinators, LNT, Grill Master/Dinner Leads, build teams, and many more)."); 
        sb.append("</ul>");
        ...
        sb.append("<p>" + Util.html(expires1) + "Follow these instructions to get started:</p>");
        sb.append("<ol>");
        ...
        sb.append("<p>" + Util.html(expires2) + "you do not intend to join Disorient on the playa this year, we ask that you visit the above link and reject the invite to keep things flowing smoothly!</p>");
        ...
        sb.append("<p>While this invitation may seem like a departure from radical inclusion it is actually the exact opposite. We will have 100% participation from each camper to make 2016 a banner year.  Everyone's sleeves are rolled up and ready to help create our tightest and brightest year yet.</p>");
        sb.append("<p>If you have any questions, feel free to contact [campemail] or reply to this email.</p>");
        sb.append("<p>Thanks for helping to make D16ORIENT tighter and brighter than ever before, and see you on the playa!</p>");
        ...
        subject = "Invitation to Apply to D16ORIENT - " + invite.getInviteeName();
